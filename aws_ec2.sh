...
main() {
    ...
    KEY_NAME="ansible1"
    SECURITY_GROUP_IDS="sg-04837982f62123628"  # Replace with your security group ID
   # SUBNET_ID="subnet-06129f6a2a2cdf843"      # Replace with your subnet ID
    INSTANCE_NAME="MyEC2Instance"

    # Call the function to create the EC2 instance
    create_ec2_instance "$AMI_ID" "$INSTANCE_TYPE" "$KEY_NAME" "$SECURITY_GROUP_IDS" "$INSTANCE_NAME"
